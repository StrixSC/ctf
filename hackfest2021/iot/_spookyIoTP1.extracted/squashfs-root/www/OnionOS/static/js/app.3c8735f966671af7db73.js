webpackJsonp([5], {
    ...
    "0Zpu": function (t, e, i) {
        ...
        var n = i("J7JO"),
            ...
            l = {
                mqtt: {
                    "#": function (t, e) {
                        this.$store.dispatch("mqttMessage", {
                            topic: e,
                            data: t
                        })
                    }
                ...
                created: function () {
                    ...
                    var t = function (t) {
                        t && "offline" === t.type ? this.$store.commit("updateInternetStatus", !1) : this.$store.dispatch("checkInternet")
                    }.bind(this);
                    t(), window.addEventListener("online", t), window.addEventListener("offline", t), this.$store.dispatch("launchApp", {
                        appId: "launcher"
                    }), this.$store.dispatch("getDeviceInfo"), this.$store.dispatch("initCDK"), this.$store.dispatch("refreshAppList")
                }
            },
            d = {
                render: function () {
                    ...
                    }), t._v(" "), i("AppView"), t._v(" "), i("LoginView"), t._v(" "), i("SetupView"), t._v(" "), i("Toast"), t._v(" "), i("About", {
                        attrs: {
        ...
        var u = i("VU/8")(l, d, !1, function (t) {
            i("RgkA")
        }, "data-v-32d93575", null);
        e.default = u.exports
    },
    "7JcZ": function (t, e) {
    ...
    E4d3: function (t, e, i) {
        ...
        function s(t) {
            var e = n[t];
            return e ? Promise.all(e.slice(1).map(i.e)).then(function () {
                return i(e[0])
            }) : Promise.reject(new Error("Cannot find module '" + t + "'."))
        }
        s.keys = function () {
            return Object.keys(n)
        }, s.id = "E4d3", t.exports = s
    },
    FkBp: function (t, e) { },
    IbZh: function (t, e) { },
    J7JO: function (t, e, i) {
        ...
        var n = {
            render: function () {
                var t = this,
                    ...
                    i = t._self._c || e;
                return i("div", {
                    staticClass: "taskbar barAlign",
                    class: {
                        solidBg: t.solidBg
                    }
                }, [i("div", {
                    staticClass: "taskBarStart barAlign"
                }, [i("div", {
                    staticClass: "starticon c-hand",
                    on: {
                        click: t.onHome
                    }
                }, [i("img", {
                    attrs: {
                        src: "static/img/icons/onion.svg",
                        alt: ""
                    }
                })])]), t._v(" "), i("div", {
                    ...
                    staticClass: "taskBarEnd barAlign"
                }, [t.$store.getters.isOnline ? t._e() : i("div", {
                    staticClass: "tooltip tooltip-dir",
                    attrs: {
                        "data-tooltip": "No Internet. Some Apps may not work"
                    }
                }, [i("i", {
                    staticClass: "icon icon-stop no-wifi-icon"
                })]), t._v(" "), i("div", {
                    staticClass: "tooltip tooltip-dir",
                    attrs: {
                        "data-tooltip": "About"
            ...
            methods: {
                ...
                closeApp: function (t, e) {
                    this.$store.dispatch("closeApp", {
                        appId: t
                    }), e.stopPropagation && e.stopPropagation(), this.hoverApp = ""
                },
                logout: function () {
            ...
            a = {
                ...
                computed: {
                    currentFirmware: function () {
                        return this.upgradeInfo.device ? this.upgradeInfo.device.version + " (b" + this.upgradeInfo.device.build + ")" : "X (bY)"
                    },
                    latestFirmware: function () {
                        return this.upgradeInfo.repo ? this.upgradeInfo.repo.version + " (b" + this.upgradeInfo.repo.build + ")" : "Z (bA)"
                    },
                    progressPercent: function () {
                        return Math.round(100 * this.view.progress.value / this.view.progress.max)
                    }
                },
                methods: {
                    setView: function (t) {
                        switch (t) {
                            case "check":
                                this.view.isLoading = !0, this.view.bUpgradeButton = !1, this.view.bProgressBar = !1, this.view.msg = "Checking if updates are available";
                                break;
                            case "needUpdate":
                                this.view.isLoading = !1, this.view.bUpgradeButton = !0, this.view.msg = "<strong>New firmware is available!</strong><br>Update your Omega to the latest and greatest firmware to get all the newest software goodies from Onion.", this.view.labelText = "Your Omega will download and install the latest firmware, this process will take about 5 minutes.<br>It's important that you <strong>do NOT unplug your Omega during the update</strong>!";
                                break;
                            case "onLatest":
                                this.view.isLoading = !1, this.view.bUpgradeButton = !1, this.view.msg = "Great, you are on the latest version, no updates required!", this.$emit("next");
                                break;
                            case "downloading":
                                this.view.isLoading = !0, this.view.bUpgradeButton = !1, this.view.bProgressBar = !0, this.view.msg = "Downloading updates, <strong>do NOT unplug your Omega!</strong>", this.view.labelText = "";
                                break;
                            case "installing":
                                this.view.isLoading = !0, this.view.bUpgradeButton = !1, this.view.bProgressBar = !0, this.view.msg = "Installing updates, <strong>do NOT unplug your Omega!</strong>";
                                break;
                            case "rebooting":
                                this.view.isLoading = !0, this.view.bUpgradeButton = !1, this.view.bProgressBar = !1, this.view.msg = "Omega is now <strong>initializing, do NOT unplug your Omega!</strong><br><br>Press Continue when your Omega stops blinking and remains on.", this.view.bShowBlink = !0, this.$emit("next")
                        }
                    },
                    ...
                    downloadFirmware: function () {
                        return new s.a(function (t, e) {
                            var i = this;
                            this.setView("downloading"), this.$store.dispatch("handleScript", {
                                code: "wget -O " + this.upgradeInfo.image.local + " " + this.upgradeInfo.image.url + " "
                            }).then(function (e) {
                                i.$store.dispatch("waitProcess", {
                                    pid: e.pid
                                }).then(function () {
                                    console.log("download complete"), clearInterval(n), t()
                                })
                            }), this.setProgressBarValue(0), this.setProgressBarMax(this.upgradeInfo.image.size);
                    ...
                    installFirmware: function () {
                        return new s.a(function (t, e) {
                            var i = this;
                            this.setView("installing"), this.$store.dispatch("handleScript", {
                                code: "sleep 1; sysupgrade " + this.upgradeInfo.image.local
                            }).then(function () {
                                var e = 0;
                                i.setProgressBarValue(e), i.setProgressBarMax(i.interval.install);
                                var n = setInterval(function () {
                ...
                created: function () {
                    var t = this;
                    this.setView("check"), this.$store.dispatch("request", {
                        object: "onion",
                        method: "oupgrade",
                        params: {
                            params: {
                        ...
                        t.upgradeInfo = e, t.upgradeInfo.upgrade ? t.setView("needUpdate") : t.setView("onLatest")
                    })
                }
            },
            o = {
                render: function () {
                    ...
                    return n("div", {
                        ...
                        staticClass: "table"
                    }, [n("tbody", [n("tr", [n("td", [t._v("Current Firmware")]), t._v(" "), n("td", [t._v(t._s(t.currentFirmware))])]), t._v(" "), n("tr", [n("td", [t._v("Latest Firmware")]), t._v(" "), n("td", [t._v(t._s(t.latestFirmware))])])])]), t._v(" "), n("div", {
                        staticClass: "upgrade-controls"
                    }, [n("button", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                        ...
                        domProps: {
                            innerHTML: t._s(t.view.labelText)
                        }
                    })])
                },
                staticRenderFns: []
    ...
    NHnr: function (t, e, i) {
        ...
        var h = function (t, e, i, n, s) {
            return new l.a(function (a, o) {
                m.a.post(t, {
                    ...
                    t.data && (t.data.result && Array.isArray(t.data.result) && void 0 !== t.data.result[0] && 0 === t.data.result[0] ? a(t.data.result[1]) : (console.log("ubus error!"), t.data.error ? o(t.data.error) : t.data.result && Array.isArray(t.data.result) && void 0 !== t.data.result[0] && o(t.data.result[0])))
                }).catch(function (t) {
                    console.error(t), o(t)
                })
            })
            ...
            g = function () {
                ! function (t, e) {
                    ...
                    n.type = "text/javascript", n.async = !0, n.src = "https://cdn.amplitude.com/libs/amplitude-4.2.1-min.gz.js", n.onload = function () {
                    ...
                    for (var o = function () {
                        return this._q = [], this
                    }, r = ["add", "append", "clearAll", "prepend", "set", "setOnce", "unset"], c = 0; c < r.length; c++) a(o, r[c]);
                    i.Identify = o;
                    for (var l = function () {
                        return this._q = [], this
                    }, d = ["setProductId", "setQuantity", "setPrice", "setRevenueType", "setEventProperties"], u = 0; u < d.length; u++) a(l, d[u]);
                    i.Revenue = l;
                    var p = ["init", "logEvent", "logRevenue", "setUserId", "setUserProperties", "setOptOut", "setVersionName", "setDomain", "setDeviceId", "setGlobalUserProperties", "identify", "clearUserProperties", "setGroup", "logRevenueV2", "regenerateDeviceId", "logEventWithTimestamp", "logEventWithGroups", "setSessionId", "resetSessionId"];
                    ...
                    v(i), i.getInstance = function (t) {
                        return t = (t && 0 !== t.length ? t : "$default_instance").toLowerCase(), i._iq.hasOwnProperty(t) || (i._iq[t] = {
                            _q: []
                        }, v(i._iq[t])), i._iq[t]
                    }, t.amplitude = i
                }(window, document), window.amplitude.getInstance().init("285e8dd4e223767a74f3dd0d8ab990ae")
            },
            w = function (t, e) {
            ...
            b = i("4P7o"),
            A = i.n(b);
        n.a.use(p.a), window.console.makeId = function () {
        ...
        var C = "" + window.location.hostname,
            ...
            I = new p.a.Store({
                state: {
                    ...
                    rpc: {
                        username: "",
                        password: "",
                        token: sessionStorage.getItem("_onion_console_session_token") || k,
                ...
                mutations: {
                    ...
                    registerSession: function (t, e) {
                        e ? (t.rpc.token = e, sessionStorage.setItem("_onion_console_session_token", e)) : (t.rpc.token = k, sessionStorage.removeItem("_onion_console_session_token"))
                    },
                    registerAppHandler: function (t, e, i) { },
                    launchApp: function (t, e) {
                        for (var s = t.apps.available[e], a = !1, o = 0; o < t.apps.running.length; o++) {
                            if (t.apps.running[o].id === s.id) {
                                a = !0;
                                break
                            }
                        }
                        a || (t.apps.running.push(s), "IframeApp" !== s.type && n.a.component(s.type, function () {
                            return i("E4d3")("./" + s.type)
                        }), "launcher" !== e && w("App - Open", {
                            app: e
                        })), t.apps.active = e
                    },
                    closeApp: function (t, e) {
                    ...
                    mqttSubscribe: function (t, e) {
                        var i = e.appUid,
                            n = e.topic;
                        n in t.mqtt.subscription ? t.mqtt.subscription[n].push(i) : t.mqtt.subscription[n] = [i]
                    },
                    ...
                    updateAppList: function (t, e) {
                        ...
                        for (var s = 0; s < e.length; s++) {
                            var a = e[s];
                            a.type = a.type || "IframeApp", a.icon = "http://" + C + "/apps/" + a.id + "/" + a.icon, a.params = a.params || {}, "IframeApp" === a.type && void 0 === a.params.url && (a.params.url = "http://" + C + "/apps/" + a.id), a.params.url = a.params.url.replace("{{host}}", C), n.a.set(t.apps.available, a.id, a)
                        }
                    }
                },
                actions: {
                    ...
                    checkInitialSetup: function (t) {
                        ...
                        return new l.a(function (t, n) {
                            i("httpGetRequest", {
                                ...
                                null !== i.data.initialSetup && e("initialSetup", i.data.initialSetup), t()
                            })
                        })
                    },
                        ...
                        return new l.a(function (t, e) {
                            h(n.rpc.url, n.rpc.token, "session", "login", {
                                ...
                                i("registerUser", {
                                    username: a,
                                    password: o
                                }), i("registerSession", e.ubus_rpc_session), s("getDeviceInfo"), s("refreshAppList"), s("startHeartbeat"), t(e)
                            }).catch(function (t) {
                    ...
                    getDeviceInfo: function (t) {
                        ...
                        if (t.getters.isAuthenticated) {
                            ...
                            l.a.all([n, s, a]).then(function (t) {
                                ...
                                }, e("deviceInfo", i), w("OnionOS - Login", i)
                            })
                        }
                    },
                    request: function (t, e) {
                        ...
                        var i = t.state,
                            ...
                            r = e.params;
                        return new l.a(function (t, e) {
                            s.isAuthenticated ? h(i.rpc.url, i.rpc.token, a, o, r).then(function (e) {
                                t(e)
                            }).catch(function (t) {
                                console.log(t), t && t.code === f.AccessDenied && (n("logout"), console.log("Session expired")), e(t)
                    ...
                    notifyApp: function (t, e) {
                        ...
                        a.data = {
                            content: s
                        }, a.name = n, window.dispatchEvent(a)
                    },
                    ...
                    initCDK: function (t) {
                        ...
                        window.addEventListener("message", function (t) {
                            var i = t.data;
                            if (void 0 !== i.event && void 0 !== i.instance && void 0 !== i.eventId && void 0 !== i.content && i.event.indexOf("Onion.CDK") > -1) switch (i.event.replace("Onion.CDK.", "")) {
                                case "Service":
                                    w(i.event, i.content), e("handleService", i).then(function (t) {
                                        ...
                                        }, e.name = i.event, window.dispatchEvent(e)
                                    });
                                    break;
                                case "Subscribe":
                                    w(i.event, i.content), e("mqttSubscribe", {
                    ...
                    handleService: function (t, e) {
                        var i = t.dispatch;
                        return new l.a(function (t, n) {
                            "start" === e.content.command || "stop" === e.content.command ? i("request", {
                                object: "file",
                                method: "exec",
                                params: {
                                ...
                                t(!1)
                            }) : "list" === e.content.command ? i("serviceStatus").then(function (i) {
                    ...
                    mqttMessage: function (t, e) {
                        ...
                        if (n in i.mqtt.subscription) {
                            var a = !0,
                                ...
                                c = void 0;
                            try {
                                for (var l, d = r()(i.mqtt.subscription[n]); !(a = (l = d.next()).done); a = !0) {
                                    var u = l.value,
                                        p = new Event("app-" + u);
                                    p.data = {
                                        content: {
                                    ...
                                    }, p.name = "Onion.CDK.Message", window.dispatchEvent(p)
                                }
                            } catch (t) {
                                o = !0, c = t
                            } finally {
                    ...
                    refreshAppList: function (t) {
                        ...
                        console.log("on refresh apps"), e.isAuthenticated && n("request", {
                            object: "onion-os",
                            method: "app-list",
                            params: {}
                        }).then(function (t) {
                    ...
                    startHeartbeat: function (t) {
                        var e = t.state,
                            i = t.dispatch;
                        e.rpc.heartbeatHandel && (clearInterval(e.rpc.heartbeatHandel), e.rpc.heartbeatHandel = null), e.rpc.heartbeatHandel = setInterval(function () {
                            i("request", {
                                object: "session",
                                method: "access",
                                params: {}
            ...
            y = {
                name: "App",
                components: {
                    ConsoleFrame: i("0Zpu").default
                },
                created: function () {
                    this.$store.dispatch("checkInitialSetup"), this.$store.dispatch("logInit")
                }
            },
            M = {
                render: function () {
        ...
        n.a.use(a.a, "ws://" + window.location.hostname + ":9001"), n.a.use(S.a, {
            id: "UA-48382427-15"
        }), new n.a({
            el: "#app",
            store: I,
            ...
            o = {
                ...
                methods: {
                    ...
                    next: function () {
                        ...
                        this.initialSetup = !1, this.$store.dispatch("setInitialSetup", {
                            value: 0
            ...
            r = {
                render: function () {
                    var t = this,
                        e = t.$createElement,
                        i = t._self._c || e;
                    return t.$store.getters.isInitialSetup ? i("div", [i("div", {
                        staticClass: "modal setup-modal",
                        class: {
                            active: t.$store.getters.isInitialSetup
                        }
                    }, [i("div", {
                        ...
                        return i("div", {
                            ...
                            staticClass: "bar-item",
                            style: {
                                width: n / (t.steps.length - 1) * 100 + "%",
                                background: t.getProgressColor(n),
                                "z-index": t.steps.length - n
                            }
                        }, [i("button", {
                            staticClass: "bar-slider-btn btn step-btn",
                            style: {
                                background: t.getProgressColor(n)
                            }
                        }, [i("div", {
                    ...
                    }))]), t._v(" "), t._l(t.steps, function (e, n) {
                        return t.currentStep === n ? i("div", {
                            key: n,
                        ...
                        }, [t._v(" " + t._s(e.heading) + " ")]) : t._e(), t._v(" "), i("div", {
                            staticClass: "setup-instruction",
                            domProps: {
                                innerHTML: t._s(e.body)
                            }
                        }), t._v(" "), e.component ? i("div", {
                        ...
                        })], 1) : t._e()]), t._v(" "), e.next || e.done || e.skip ? i("div", {
                        ...
                        }, [t._v("Continue")]) : t._e(), t._v(" "), e.skip ? i("button", {
                            staticClass: "btn btn-link",
                            on: {
                                click: t.next
                            }
                        }, [t._v("Skip")]) : t._e(), t._v(" "), e.done ? i("button", {
                            staticClass: "btn",
                            on: {
                                click: t.done
                            }
                        }, [t._v("Enter OnionOS")]) : t._e()]) : t._e()]) : t._e()
                    })], 2)]) : t._e()
                },
                staticRenderFns: [function () {
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("div", {
                        staticClass: "setup-image"
                    }, [e("img", {
                        attrs: {
                            src: "static/img//Onion-Logo-Full.png",
                            alt: ""
                        }
                    })])
                }]
            };
        var c = i("VU/8")(o, r, !1, function (t) {
            i("hXiX")
        }, "data-v-76b4f7a5", null);
        e.default = c.exports
    },
    c27y: function (t, e, i) {
        "use strict";
    ...
    gosb: function (t, e, i) {
        ...
        var n = {
            render: function () {
                ...
                }, [t._v("Login")]), t._v(" "), i("div", {
                    staticClass: "divider login-devider"
                }), t._v(" "), t._m(0)])
            },
            staticRenderFns: [function () {
                var t = this.$createElement,
                ...
                }, [this._v("Need help?"), e("br"), this._v("Read our "), e("a", {
                    attrs: {
                        href: "http://onioniot.com/getstarted",
                        target: "_blank"
                    }
                }, [this._v("getting started guide")])])
            }]
        };
        var s = i("VU/8")({
            name: "LoginForm",
                ...
                makeToast: function (t, e) {
                    ...
                    var n = setInterval(function () {
                        ...
                        if (-1 !== t) {
                            ...
                            e.value -= 1, e.value <= 0 && (clearInterval(n), this.close(t))
                        } else clearInterval(n)
                    }.bind(this), 1e3 * this.timeout / 100)
                },
                close: function (t) {
            ...
            s = {
                render: function () {
                    ...
                    return i("div", {
                        ...
                        }), t._v(" "), e.title ? i("h6", [t._v("Title")]) : t._e(), t._v("\n      " + t._s(e.message) + "\n      "), i("div", {
                            staticClass: "bar bar-sm"
                        }, [i("div", {
                            staticClass: "bar-item",
                            style: {
                                width: e.value + "%"
        ...
        var n = {
            render: function () {
                ...
                return i("div", {
                    staticClass: "modal modal-sm",
                    class: {
                        active: !t.$store.getters.isAuthenticated
                    }
                }, [i("div", {
                    staticClass: "modal-container"
                }, [t._m(0), t._v(" "), i("div", {
            ...
            s = {
                render: function () {
                    var t = this,
                        ...
                        i = t._self._c || e;
                    return i("div", {
                        staticClass: "frameview"
                    }, [!t.$store.getters.isOnline && t.params.internet ? i("div", {
                        staticClass: "empty"
                    }, [t._m(0), t._v(" "), i("p", {
                        staticClass: "empty-title h5"
                    }, [t._v("This App require an Internet Connection")]), t._v(" "), i("p", {
                        staticClass: "empty-subtitle"
                    }, [t._v("Please make sure your computer is connected to the Internet")])]) : t._e(), t._v(" "), t.$store.getters.isOnline || !t.params.internet ? i("iframe", {
                        ref: t.AppUid,
                        attrs: {
                            src: t.params.url,
                            width: "100%",
            ...
            a = {
                ...
                computed: {
                    ...
                    passwordFormHintText: function () {
                        var t = this.validatePassword(this.inputNetwork.encryption, this.inputNetwork.password).err;
                ...
                methods: {
                    ...
                    scanForWifi: function () {
                        return new s.a(function (t, e) {
                            this.$store.dispatch("request", {
                                ...
                                i.results && i.results instanceof Array ? t(i.results) : e()
                            }).catch(function (t) {
                                e(t)
                            })
                        }.bind(this))
                    ...
                    internetConnectivityCheck: function () {
                        return new s.a(function (t, e) {
                            this.$store.dispatch("request", {
                                ...
                                void 0 !== i && void 0 !== i.code && 0 === i.code ? t(!0) : e(!1)
                            })
                        }.bind(this))
                    },
                    addNetwork: function (t, e, i) {
                        console.log("joining network"), this.$store.dispatch("request", {
                            object: "onion",
                            method: "wifi-setup",
                            params: {
                                command: "add",
                    ...
                    validatePassword: function (t, e) {
                        ...
                        switch (t) {
                            case "psk":
                            case "psk2":
                                e.length < 8 ? (i = !1, n = "Password must be 8 characters or more") : e.length > 63 ? (i = !1, n = "Password must be less than 64 characters") : i = !0;
                                break;
                            case "wep":
                                5 !== e.length && 13 !== e.length ? (i = !1, n = "Password must be either 5 or 13 characters") : i = !0;
                                break;
                            case "none":
                                i = !0;
                                break;
                    ...
                    joinNetwork: function () {
                        this.addNetwork(this.inputNetwork.ssid, this.inputNetwork.encryption, this.inputNetwork.password), this.setView("joiningNetwork");
                        var t = setInterval(function () {
                            var i = this;
                            this.internetConnectivityCheck().then(function () {
                                clearInterval(t), clearTimeout(e), console.log("Device successfully connected to the internet!!"), i.setView("connectionSuccess"), setTimeout(function () {
                                    i.completeWifiConfig()
                                }, 3e3), i.readNetworkList().then(function (t) {
                                    i.wifi.configured = t
                                })
                            }).catch(function (t) { })
                        }.bind(this), 1e3 * this.wifi.interval.connectionCheck),
                            e = setTimeout(function () {
                                this.setView("connectionFail")
                            }.bind(this), 1e3 * this.wifi.interval.connectionTimeout)
                    },
                ...
                created: function () {
                    ...
                    e.then(function (e) {
                        t.wifi.configured = e, t.skipIfConnected && t.wifi.configured.length > 0 && (console.log("have configured networks, checking for internet connectivity"), t.internetConnectivityCheck().then(function (e) {
                            console.log("device already connected to internet, can skip wifi setup"), t.setView("skipStep")
                        }).catch(function (t) {
                ...
                render: function () {
                    ...
                    return n("div", {
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: !t.view.bLoading && t.viewConfiguredNetworks && t.wifi.configured.length > 0,
                            expression: "!view.bLoading && viewConfiguredNetworks && wifi.configured.length > 0"
                        }],
                        staticClass: "card"
                    }, [t._m(0), t._v(" "), n("div", {
                    ...
                    }, [n("tbody", t._l(t.wifi.configured, function (e) {
                        return n("tr", {
                            key: e.ssid,
                            class: {
                                active: e.enabled
                            }
                        }, [n("td", [t._v(t._s("" !== e.ssid ? e.ssid : "hidden"))]), t._v(" "), n("td", {
                            staticClass: "wifi-icons"
                        }, ["none" !== e.encryption ? n("img", {
                            attrs: {
                                src: i("B4+s"),
                                alt: ""
                            }
                        }) : t._e(), t._v(" "), "none" === e.encryption ? n("img", {
                            attrs: {
                                src: i("7JcZ"),
                                alt: ""
                            }
                        ...
                        staticClass: "table table-hover"
                    }, [n("tbody", t._l(t.wifi.scanned, function (e) {
                        return n("tr", {
                            key: e.bssid,
                            on: {
                                click: function (i) {
                        ...
                        }, [e.ssid.length > 0 ? n("td", [t._v(t._s(e.ssid))]) : n("td", [n("span", {
                            staticClass: "text-italic"
                        }, [t._v("Hidden")])]), t._v(" "), n("td", {
                            staticClass: "wifi-icons"
                        }, ["none" !== e.encryption ? n("img", {
                            attrs: {
                                src: i("B4+s"),
                    ...
                    }, [t._v(t._s(t.view.modalTitle))])]), t._v(" "), n("div", {
                        staticClass: "modal-body"
                    }, [n("div", {
                        directives: [{
                            name: "show",
                        ...
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: t.view.bModalForm && "none" !== t.inputNetwork.encryption,
                            expression: "view.bModalForm && inputNetwork.encryption !== 'none'"
                        }],
                        staticClass: "form-group"
                    }, [n("label", {
                    ...
                    }, [t._v('Enter the password for "' + t._s(t.inputNetwork.ssid) + '"')]), t._v(" "), n("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model",
                        ...
                        on: {
                            keyup: function (e) {
                                return "button" in e || !t._k(e.keyCode, "enter", 13, e.key, "Enter") ? t.joinNetwork(e) : null
                            },
                            input: function (e) {
                                e.target.composing || t.$set(t.inputNetwork, "password", e.target.value)
                            }
                        }
                    }), t._v(" "), n("p", {
                        directives: [{
                    ...
                    }, [t._v(t._s(t.passwordFormHintText))])]), t._v(" "), n("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                        ...
                        domProps: {
                            innerHTML: t._s(t.view.modalText)
                        }
                    })]), t._v(" "), n("div", {
                        directives: [{
                            name: "show",
                    ...
                    }, [t._v("Join")])]), t._v(" "), n("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: "tryAgain" === t.view.modalButtons || "skip" === t.view.modalButtons,
                            expression: "view.modalButtons === 'tryAgain' || view.modalButtons === 'skip'"
                        }],
                        staticClass: "modal-footer"
                    }, [n("button", {
                        directives: [{
                    ...
                    }, [t._v("Try Again")]), t._v(" "), n("button", {
                        staticClass: "btn",
                        on: {
                            click: t.skipWifiConfig
                        }
                    }, [t._v("Skip Step")])])])])])
                },
                staticRenderFns: [function () {
                    ...
                    return e("div", {
                        ...
                        staticClass: "card-title h5"
                    }, [this._v("Select a Network...")])])
                }]
            };
        var r = i("VU/8")(a, o, !1, function (t) {
            i("FkBp")
        }, "data-v-38544937", null);
        e.default = r.exports
    }
}, ["NHnr"]);
